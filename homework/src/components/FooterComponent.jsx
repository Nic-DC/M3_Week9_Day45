            ...
            <ul class="navbar-nav ">
              <li class="nav-item flex-start">
                <svg
                  ...
                  height="24"
                  fill="currentColor"
                  class="bi bi-facebook text-secondary me-2 mr-3"
                  viewBox="0 0 16 16"
                >
                ...
                <svg
                  ...
                  height="24"
                  fill="currentColor"
                  class="bi bi-instagram text-secondary me-2 mr-3"
                  viewBox="0 0 16 16"
                >
                ...
                <svg
                  ...
                  height="24"
                  fill="currentColor"
                  class="bi bi-twitter text-secondary me-2 mr-3"
                  viewBox="0 0 16 16"
                >
              ...
              <li class="nav-item mt-2">
                <a class="nav-link text-muted">© 1997-{new Date().getFullYear()} Netflix Inc</a>
              </li>
            </ul>
          </div>
          <div class="col-md-3">
